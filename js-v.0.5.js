         ...
         *
         * next version:
         * +- панель управления настройками и стратегиями (с переключатилями)
        ...
        let setting = {
            ...
            url: [
                { apiBinance: "https://api.binance.com/api/v1/klines" },
                { tradeBinance: "https://www.binance.com/ru/trade/BTC_USDT?layout=basic" },
            ],
            isAdmin: true
        };
        // получаем свойства объекта:
         //console.log(setting.timer[1].SmServer); // '-0.30'
        ...
        function urlPrice(x) {
            ...
            url.searchParams.set("interval", setting.interval[0].Sm);
        ...
        function procent(a, b) {
            ...
            if (c >= 0.34) { // если цена вырастет до 0.80%
        ...
        */
        ...
        function run() {
            getPrice(function(event) {
                ...
                tableCreate(procent(price[0][1], price[0][4]) + "%", price[0][1], "0.33% (5m)", "BUY", timeDate());
                //createElem(procent(price[0][1], price[0][4]) + "% [" + timeDate() + "]", price[0][1] + " ==> " + price[0][4] + "  [" + price + "]"); // расчет процентов
                //console.log(date);
                console.log(price);
                timer(setting.timer[0].SmClient); // 15 минут
            });
        };
        ...
        function go() {
            ...
            setInterval(function() {
                run();
            }, setting.timer[1].SmServer) // 15 минут
        };
        DOMLoaded(function() {
            //localStorage.clear();
            timeDate();
