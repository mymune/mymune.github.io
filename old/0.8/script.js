         ...
         * + подготовка к большым изменений в слудующий версии
         *
         *
         * pre-release: v.0.9
         * - база даных
         * - улучшить и переписать код (es6) https://learn.javascript.ru/arrow-functions-basics
         * - единствиная  функция по оброботке ошибок
